...
Нужно найти вектор параметров *w*, при котором достигается минимум эмпирического риска:
 ...
 ![default](https://user-images.githubusercontent.com/44859059/50449956-b40d4600-093b-11e9-9a60-1ad3b88cf14f.png)( *L(M)* - фукция потерь, она непрерывна и неотрицательна, наша цель это ее минимизация).
